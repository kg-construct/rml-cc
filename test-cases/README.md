...
- RMLTC-CC-0010-Lista: Combining graph maps and gather maps (a blank node for each list)
- RMLTC-CC-0010-Listb: Combining graph maps and gather maps (lists are merged via blank node identifiers)