...
This section describes the RML-CC test cases. These descriptions are also available as RDF.
The files are available on [GitHub](https://github.com/kg-construct/rml-cc/tree/main/test-cases) in the folder `test-cases`.
